...
This is a simple Vue.js application that analyzes the tokenization process of the Deepgram API
and determines the total number of tokens in a given piece of audio or text.
